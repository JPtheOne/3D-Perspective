...
namespace Perspectiva_3D
{
    public class Scene
    {
        ...
        public Pen pen = new Pen(Color.DeepSkyBlue);
        public int angle;
        ...
        public void Draw(Graphics graphics, int viewWidth, int viewHeight) //Method to draw both axis and the 6 faces of the cube
        {
            graphics.Clear(Color.FromArgb(0,0,0));

            // Draw x-axis
            graphics.DrawLine(new Pen(Color.White), 0, viewHeight / 2, viewWidth, viewHeight / 2);

            // Draw y-axis
            graphics.DrawLine(new Pen(Color.White), viewWidth / 2, 0, viewWidth / 2, viewHeight);
